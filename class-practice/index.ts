...
class cities {
  ...
  //   }
  static country: string = `pakistan`;
...
// var a = new cities(`faisalbad`, 3456789);
// console.log(cities.country);
// class Pair<y, o> {
//   constructor(public first: y, public second: o) {}
// }

// let pair = new Pair<any, string>(prompt(`hehhwwhwhwwhwhwhwhhw`), "forty-two");
// console.log(pair);
type students<t> = {
  name: string;
  class: t;
...
class a<t, u> {
  ...
  age: t;
  Class: u;
  constructor(name: string, age: t, Class: u) {
    this.Class = Class;
    this.age = age;
    this.name = name;
  }
}
var b = new a<number, number>(`Ahmad`, 13, 8);
console.log(b);
