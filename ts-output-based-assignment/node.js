...
//   console.log(`this is not an alphabet `);
// }
var week = prompt(`Enter a number (1-7) to know what is the day of week today`);
if (week == 1) {
...
var num5 = prompt(`enter third number`);
num3 > num4 && num3 > num5
    ? num4 > num3 && num4 > num5
...
var f = prompt(`enter a number to know wether the number is positive or negative or zero`);
f > 0
...
var x = prompt(`enter a number to know wether the number is dividible by 5 and 11 or not`);
x % 5 == 0
...
var sheraz = prompt(`enter a number to know wether number is odd or even `);
sheraz % 2 == 0
