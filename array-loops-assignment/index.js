...
var arrOfIntegers = [4, 9, 16, 21, 30];
...
var sumOfSquares = sum.reduce((h1, h2) => h1 + h2);
...
var product = [-2, 3, -4, 5, -6];
var productOfPositives = product.filter((value) => value > 0);
var productOfPositives1 = productOfPositives.reduce((value1, value2) => value1 * value2);
...
var uppercase = ["Alice", "Bob", "Charlie"];
...
var words = ["apple", "banana", "grape", "kiwi"];
...
var sumOfAges = objects.reduce((value1, value2) => value1.age + value2.age);
